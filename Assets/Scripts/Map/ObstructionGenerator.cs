...
/// <summary>
/// This script is designed to be a component of ObstructionGenerator prefab for dynamic
/// generation of obstruction tile variants. Each obstructor will be given a
...
public class ObstructionGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Set values
        obstructor.transform.localPosition = new Vector3(positionX, 1.0f, positionZ);
        obstructor.transform.localScale = new Vector3(scaleX, 2.0f, scaleZ);
